        	...
        	$(function(){
        		//아이디 입력하는 input 요소객체 변수에 담아두기
        	 	...
        	 	$idInput.keyup(function(){
        	 		...
        	 		//우선 최소 5글자 이상으로 입력됐을때만 ajax 요청해서 중복체크 하도록
        	 			...
        	 			$.ajax({
        	 				...
        	 				success:function(result){
        	 					if(result === "NNNNN"){//사용불가능
        	 						//빨간색 메시지(사용불가능) 출력
        	 						$("#checkResult").show();
        	 						$("#checkResult").css("color","red").text("ㅗ")
        	 						...
        	 						//초록색 메시지
        	 						$("#checkResult").show();
        	 						$("#checkResult").css("color","green").text("쓰던가")
        	 						
        	 						//버튼 활성화
        	 						$("#enrollForm :submit").removeAttr("disabled",true);
        	 					}
        	 				},
        	 				error:function(){
